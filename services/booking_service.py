...
def create_booking(data):
    ...
    try:
        ...
        if dec.rowcount != 1:
            ...
            return {
                "error": f"Not enough seats. Only {row.seats_available} available."
            }, 400
    ...
    return {
        ...
        "booking": {
            ...
            "departure_time": (schedule.departure_time or "").split("T")[-1],
...
def get_user_bookings(user_id):
    bookings = (
        Booking.query.filter_by(user_id=int(user_id))
